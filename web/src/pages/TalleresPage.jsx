...
export const TalleresPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.fecha_clase) {
      showNotification('error', 'Debes ingresar la fecha en que se realizará la clase.');
      return;
    }
    ...
    if (res.success) {
      ...
      showNotification(
        'error',
        res.message || 'Conflicto de horario: La sala ya se encuentra ocupada en ese bloque horaria.'
      );
    } else {
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <select
                ...
                required
              >
                {profesionales.length === 0 && <option value="">Cargando profesionales...</option>}
                {profesionales.map((p) => (
